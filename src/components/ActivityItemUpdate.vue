<template>
    ...
    <div class="activity-title">
      <!-- TODO: Add v-model -->
      <i class="fa fa-cog activity-settings" @click="isMenuDisplayed = !isMenuDisplayed" />
      <input v-model="NewUpdateActivity.title" type="text" class="input">
    </div>
    <div class="activity-category">
      <!-- TODO: add v-model and iterate categories in option  -->
      <select v-model="NewUpdateActivity.category" class="select">
    ...
    <div class="control activity-notes">
      ...
      <textarea v-model="NewUpdateActivity.notes"
                class="textarea"
    ...
    <div class="media">
      ...
      <div class="media-content">
        <div class="content">
          <p>
            <a href="#">Filip Jerga</a> updated {{ NewUpdateActivity.updatedAt | prettyTime }} &nbsp;
          </p>
        </div>
      </div>
      <div class="media-right">
        <!-- TODO: Add v-model here -->
        <input id="progress"
               v-model.number="NewUpdateActivity.progress"
               type="range"
               name="progress"
               min="0" max="100" value="90" step="10">
        <label for="progress"> {{ NewUpdateActivity.progress }} %</label>
      </div>
    </div>
...
export default {
  ...
  data () {
    return {
      ...
      NewUpdateActivity: { ...this.activity }
    }
  },
  methods: {
    updateActivity () {
      store.updateActivity(this.NewUpdateActivity)
        .then(() => {
